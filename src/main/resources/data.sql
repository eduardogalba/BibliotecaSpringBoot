...
UPDATE libro SET prestados = prestados + 1 WHERE libroId = 1;
UPDATE libro SET prestados = prestados + 1 WHERE libroId = 2;
UPDATE libro SET prestados = prestados + 1 WHERE libroId = 3;
